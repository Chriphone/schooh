...
def blog(request):
    ...
    return render(request,'school/source/blog.html',
        {})
def course(request):
    
    return render(request,'school/source/courses.html',
        {})
def events(request):
    
    return render(request,'school/source/events.html',
        {})
def admision(request):
    return render(request,'school/admision.html',
        {})
...
def contact(request):
    if request.method=="POST":
        ...
        return render(request,'school/source/contact.html',
...
def addmark(request,pk):
    ...
    return render(request,'school/addmarks.html',context=mydict)
...
def marks(request):
    ...
    return render(request,'school/marks.html',{'students':students})
...
def home_view(request):
    ...
    return render(request,'school/index.html', {"sliderdata":sliderdata})
...
def update_student_view_marks(request,pk):
    ...
    if request.method=='POST':
        ...
        if form1.is_valid() and form2.is_valid():
            ...
            f2.save()
            return redirect('admin-view-student')
    return render(request,'school/updatemarks.html',context=mydict)
